    ...
    do
        ...
        do
            ...
            do
                ...
                python3 main.py CDN --cdn 129.114.26.127:8095 --cdn-catalog ddbb0616acf60b098cfb34e6bcbdd3970bf1583fdb11320dc60243529185e502  --cdn-usertoken 574de8363e76b9e104b8e4b0b58d4e6e0250bc4c1f028140e08cc803f31e8d77 --ops SET --files /DATA/dsanchez/random/10GB  --repeat=5 --clients $i  --resiliency $j --parallel $k  --csv-file 10GBvarying${m}_res_${j}_parallel_${k}.csv
                ...
                #python3 main.py CDN --cdn 129.114.26.127:8095 --cdn-catalog ddbb0616acf60b098cfb34e6bcbdd3970bf1583fdb11320dc60243529185e502  --cdn-usertoken 574de8363e76b9e104b8e4b0b58d4e6e0250bc4c1f028140e08cc803f31e8d77 --ops SET --files /DATA/dsanchez/random/1000M  --repeat=2 --clients $i  --resiliency $j --parallel $k  --csv-file varying${m}_res_${j}_parallel_${k}.csv	
